      ...
      <main className="flex-1">
        ...
        <section className="screen border-b border-[#E7E5D8] py-16 md:py-24 bg-[#F4F3E8]/50 border-b-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            {/* Big card */}
            <Link href="/routes/ghost-romania" className="md:col-span-7 bg-white border border-[#E7E5D8] rounded-[28px] overflow-hidden group hover:border-[#CCFF00] transition-all shadow-xs flex flex-col">
              ...
              <div className="p-7 flex-1 flex flex-col justify-between">
                <div>
                  <h3 className="text-2xl font-black mb-2 text-[#15150F] group-hover:text-[#3A4A00] transition-colors">Carpathian Ridge & Night Rail</h3>
                  <p className="text-[14px] text-[#5B5B52] leading-relaxed">Unmarked forest paths, wooden sleeper coaches, foggy mountain cabins no guide mentions.</p>
                </div>
