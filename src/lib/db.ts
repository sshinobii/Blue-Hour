...
const INITIAL_ROUTES: Route[] = [
  {
    ...
    description: 'Ancient stone paths, high mountain ridges, cedar forest shelters, and quiet waterfall passes walked entirely on foot.',
    mood_prompt: 'Misty forest trail trek, mountain cabins, zero tourist traps',
    category: 'Hiking',
    budget_amount: 650,
    budget_currency: 'EUR',
    days: 8,
    ...
    stops: [
      {
        id: 'st-1',
        route_id: 'kumano-trek',
        order_index: 0,
        name: 'Nakahechi Pass',
        description: 'Ancient mossy stone trail & mountain forest pass',
        lat: 33.7845,
        lng: 135.5392,
        day_range: 'Day 1-2',
      },
      {
        ...
        order_index: 1,
        name: 'Kogenchi Ridge',
        description: 'High alpine mountain ridge & wooden hiker shelter',
        lat: 33.8211,
        lng: 135.6814,
        day_range: 'Day 3-5',
      },
      {
        ...
        order_index: 2,
        name: 'Hongu Valley',
        description: 'Hidden waterfall valley & quiet cedar bathhouse finish',
        lat: 33.8406,
        lng: 135.7738,
        day_range: 'Day 6-8',
      }
