...
const INITIAL_ROUTES: Route[] = [
  {
    ...
    description: 'Misty bamboo forests, mountain night trains, cedar bathhouses, and quiet vinyl bars in Takayama.',
    mood_prompt: 'Slow rainy train through Japanese Alps, local tea, zero tourist traps',
    category: 'Rail',
    budget_amount: 650,
    budget_currency: 'EUR',
    days: 8,
    ...
    stops: [
      {
        id: 'st-1',
        route_id: 'alpine-japan',
        order_index: 0,
        name: 'Takayama',
        description: 'Old wooden merchant streets & mountain tea houses',
        lat: 36.1408,
        lng: 137.2513,
        day_range: 'Day 1-2',
      },
      {
        ...
        order_index: 1,
        name: 'Nagano',
        description: 'Cedar mountain trails & quiet cedar bathhouses',
        lat: 36.6485,
        lng: 138.1942,
        day_range: 'Day 3-5',
      },
      {
        ...
        order_index: 2,
        name: 'Kanazawa',
        description: 'Lantern-lit samurai district & basement vinyl bars',
        lat: 36.5613,
        lng: 136.6562,
        day_range: 'Day 6-8',
      }
